  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-40 md:hidden">
      <div className="flex items-center justify-between gap-3 rounded-2xl border border-accent/30 bg-primary/95 p-3 text-white shadow-2xl backdrop-blur-md">
        ...
        >
          <div className="relative flex size-11 items-center justify-center rounded-xl bg-accent text-primary">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={openCart}
            className="flex items-center gap-2 rounded-xl bg-accent px-4 py-2.5 font-body text-xs font-bold text-primary transition-transform active:scale-95 shadow-md"
          >
            <span>Panier</span>
